...
#define GENERAL_CAT_LENGTH              (19*2)
#define GROUP_STR_INDEX_OFF         (0x0000*2)      // Offset of group string index in category (Index into strings)
#define IMG_INDEX_OFF               (0x0001*2)
#define ORDER_INDEX_OFF             (0x0002*2)
#define NAME_INDEX_OFF              (0x0003*2)
#define COE_DETAILS_OFF             (0x0005*2)
#define FOE_DETAILS_OFF             (0x0006*2)
#define EOE_DETAILS_OFF             (0x0007*2)
#define FLAGS_OFF                   (0x000B*2)
#define EBUS_CURRENT_OFF            (0x000C*2)
#define PHY_PORT_OFF                (0x0010*2)

// Sync Manager Category structure, repeated for as many sync managers as used
#define SYNCM_CAT_LEN                    (8*2)
#define SYNCM_PHY_ADDR_OFF          (0x0000*2)
#define SYNCM_LENGTH_OFF            (0x0002*2)
#define SYNCM_CTRL_REG_OFF          (0x0004*2)
#define SYNCM_ENABLE_OFF            (0x0006*2)
#define SYNCN_TYPE_OFF              (0x0007*2)

// PDO Category strucure, repeated for each PDO
#define PDO_CAT_FIXED_LEN                (8*2)      // Length of fixed section of PDO category in addition to size of entry list
#define PDO_INDEX_OFF               (0x0000*2)      // Offset of PDO index from beginning of PDO
#define PDO_NENTRY_OFF              (0x0002*2)      // Offset of stored value of entries
#define PDO_SYNCM_OFF               (0x0003*2)
#define PDO_SYNCRONIZATION          (0x0004*2)
#define PDO_NAME_INDEX_OFF          (0x0005*2)      // Index into strings category
#define PDO_ENTRY_START             (0x0008*2)      // Offset of begging of PDO entry list

// PDO Entry subcategory structure, repeated for each PDO entry
#define ENTRY_CAT_LENGTH                 (8*2)
#define ENTRY_INDEX_OFF             (0x0000*2)
#define ENTRY_SUBINDEX_OFF          (0x0002*2)
#define ENTRY_NAME_IDX_OFF          (0x0003*2)      // Index into strings category
#define ENTRY_DATA_TYPE_OFF         (0x0004*2)
#define ENTRY_BITLEN_OFF            (0x0005*2)

// DC Clock Category structure
#define DC_CAT_LENGTH                   (24*2)
#define DC_CYCLE_SYNC0_OFF          (0x0000*2)
#define DC_SHIFT_SYNC0_OFF          (0x0004*2)
#define DC_SHIFT_SYNC1_OFF          (0x0008*2)
#define DC_CYCLE_SYNC1_FACTOR_OFF   (0x000C*2)
#define DC_ASSIGN_ACTIVATE_OFF      (0x000E*2)
#define DC_CYCLE_SYNC0_FACTOR_OFF   (0x0010*2)
#define DC_SYNC_NAME_INDEX_OFF      (0x0012*2)      // Index into strings category

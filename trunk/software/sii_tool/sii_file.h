...
#define SII_CONFIG                  0x0000     // Start of Slave Information configuration area
#define SII_CATEGORIES              0x0040     // Start of Slave categories area

// Slave config Section
#define CONFIG_DATA                 0x0000     // Start of config data
#define CONFIG_CHECK                0x0007     // Address of config data checksum
#define VENDOR_ID                   0x0008     // Address of vendor ID in sii file
#define PRODUCT_CODE                0x000A
#define REV_NUMBER                  0x000C
#define SERIAL_NUMBER               0x000E
#define BOOTSTRAP_DATA              0x0014     // Start of Bootstrap data section
#define RX_MBOX_OFF                 0x0018
#define RX_MBOX_SIZE                0x0019
#define TX_MBOX_OFF                 0x001A
#define TX_MBOX_SIZE                0x001B
#define MBOX_PROTOCOL               0x001C
#define EEPROM_SIZE                 0x003E
#define VERSION                     0x003F

// Category section
#define CAT_TYPE_OFF                0x0000     // Offset from beginning of category entry of type value
#define CAT_SIZE_OFF                0x0001     // Offset from start of cateogry entry of size
#define CAT_DATA_OFF                0x0002     // Offset of begging of actual category data
